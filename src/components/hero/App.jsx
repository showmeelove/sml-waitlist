      ...
      <div className="mx-auto">
        ...
        <div className="mx-auto max-w-[326px] mt-[40px] md:mt-[30px] md:max-w-[901px] ">
          <h1 className="text-white text-[38px] leading-[43px] md:text-[64px] md:leading-[70px] md:w-full font-Eina01Bold lowercase text-center">
            Let your fans{" "}
            <span className="bg-clip-text text-transparent text-[38px] leading-[43px] md:text-[64px] md:leading-[70px] font-Eina01Bold lowercase bg-gradient-to-r from-[#1864FF] to-[#42AAFF]">
              Show you love
            </span>{" "}
            for your contents
          </h1>
          <div className="mx-auto max-w-[700px]">
            <p className="md:block hidden mt-[45px] text-center lowercase font-medium font-figtree text-[20px] leading-[33px] text-[#EEEEEE] max-w-[700px] ">
          ...
          <div className="mx-auto max-w-[345px]">
            <p className="md:hidden font-figtree mx-[10px] mt-[29px] text-[16px] leading-[28px] font-medium text-showgray max-w-[364px] text-center ">
              Got a devoted fanbase? <br /> join our waitlist to get early access to
