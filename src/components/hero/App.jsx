...
const App = () => {
  ...
  return (
    <div className="body container">
      <div>
        <h1 className="text-[22px] mt-[30px] leading-[25.78px] md:text-[32px] md:leading-[42.19px] md:mt-[10px] text-[#EEEEEE] lowercase font-bold text-center font-Eina01Bold">
          ShowMeeLove.
        </h1>
        <div className="mt-[30px] md:mt-[60px] rounded-[50px] max-w-[258px] mx-auto bg-lightblue">
        ...
        <div className="mx-auto max-w-[356px] mt-[20px]  md:mt-[35px] md:max-w-[901px] ">
          ...
          <p className="md:hidden font-figtree mt-[20px] text-[16px] leading-[28px] font-medium text-showgray max-w-[364px] text-center ">
