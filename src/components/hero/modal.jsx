...
const Modal = ({ setModalOpen }) => {
  return (
    <div className="z-40 text-white bg-[#111621]/50 backdrop-blur-sm fixed top-0 right-0 left-0 h-[100%] w-[100%] overflow-hidden flex justify-center items-center">
      <div className="flex flex-col justify-center items-center max-w-[390px] h-[508px] md:max-w-[582px] bg-[#111621] md:h-[631px] drop-shadow-xl py-4 px-[2rem] rounded-[20px] md:rounded-[30px]">
        ...
        <p className="text-showgray text-[15px] leading-[25px] max-w-[317px] mt-[30px] md:mt-[42px] md:max-w-[501px] font-figtree font-medium md:text-[20px] md:leading-[33px] text-center ">
