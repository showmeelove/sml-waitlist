      ...
      >
        ...
        <div className="md:absolute relative md:top-[-12] md:bottom-2 md:right-2">
          <button
            ...
            className={`w-[351px] h-[58px] mx-auto px-4  md:h-[62px] md:w-[193.48px] md:text-[16.17px] md:leading-[29.65px] font-medium  text-white text-center bg-[#012C6B] md:hover:bg-gradient-to-r from-[#1864FF] to-[#42AAFF] rounded-[35.942px]`}
          >
